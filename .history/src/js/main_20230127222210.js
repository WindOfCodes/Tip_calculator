...
const tipForPrsn = document.querySelector("#tipForPrsn");
const totalForPrsn = document.querySelector("#totalForPrsn");
...
function calculateTip() {
  if (peopleValue >= 1) {
    ...
    tipForPrsn.innerHTML = "$" + tipAmount.toFixed(2);
    totalForPrsn.innerHTML = "$" + total.toFixed(2);
  }
}
